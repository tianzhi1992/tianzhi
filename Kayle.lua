...
function OnLoad()
if GetUser() == "zhanghao11" or  GetUser() == "hnhy617369" or GetUser() == "835390" or  GetUser() == "fflovezj1221" or GetUser() == "lengbina001" or GetUser() == "kf9299" or GetUser() == "jiahongbinx" or GetUser() == "nady69" or  GetUser() == "tianzhi1992"or  GetUser() == "andrewls"
...
if  not allowed then PrintChat("<font color='#CCCCCC'> >>[tz]kayle未认证用户请联系作耿</font>") return end
	...
	KayleConfig:addSubMenu("combo", "Combo")
	...
	--> Heal Settings
	KayleConfig:addSubMenu("heal", "Heal")
	KayleConfig.Heal:addSubMenu("healtargeting", "HealTargeting")
	KayleConfig.Heal:addParam("PercentofHealth", "ʹpercentofHealth",SCRIPT_PARAM_SLICE, 25, 0, 100, 0)	
	KayleConfig.Heal.HealTargeting:addParam(myHero.charName.."healTarget", "healtarget".. myHero.charName, SCRIPT_PARAM_ONOFF, true)
	for i, ally in ipairs(GetAllyHeroes()) do
		KayleConfig.Heal.HealTargeting:addParam(ally.charName.."healTarget", "healtarget"..ally.charName, SCRIPT_PARAM_ONOFF, true)
	end
	KayleConfig.Heal:addParam("healAllies", "healallies", SCRIPT_PARAM_ONOFF, true)
	--> Ult Settings
    KayleConfig:addSubMenu("ult", "ult")
	KayleConfig.ult:addSubMenu("ultTargetting", "ultTargeting")
	KayleConfig.ult:addParam("PercentofUlt", "percentofult",SCRIPT_PARAM_SLICE, 25, 0, 100, 0)	
	KayleConfig.ult:addParam("ultAllies", "ultallies", SCRIPT_PARAM_ONOFF, false)
	KayleConfig.ult:addParam("myult", "myult", SCRIPT_PARAM_ONOFF, true)
	KayleConfig.ult.ultTargeting:addParam(myHero.charName.."ultTarget", "ulttarget".. myHero.charName, SCRIPT_PARAM_ONOFF, true)
	for i, ally in ipairs(GetAllyHeroes()) do
		KayleConfig.ult.ultTargeting:addParam(ally.charName.."ultTarget", "ultTarget "..ally.charName, SCRIPT_PARAM_ONOFF, true)
	end
	KayleConfig:addSubMenu("KS", "KS")
	KayleConfig.KS:addParam("autoignite", "Autoignite", SCRIPT_PARAM_ONOFF, true)
	KayleConfig.KS:addParam("killSteal", "killsteal", SCRIPT_PARAM_ONOFF, true)

	KayleConfig:addSubMenu("Draw", "Draw")
	KayleConfig.Draw:addParam("qDraw", "Qdraw", SCRIPT_PARAM_ONOFF, true)
    KayleConfig.Draw:addParam("cDraw", "Edraw", SCRIPT_PARAM_ONOFF, true)
